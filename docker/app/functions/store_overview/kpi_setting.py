...
FROM tibame_project.product_detail
GROUP BY date_time;'''
...
df.to_csv(f'./train_data/{year}{month}_train_data.csv', index=False)
print(f'完成匯出 {year}{month}_train_data ')
